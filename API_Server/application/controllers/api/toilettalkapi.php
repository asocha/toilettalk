...
class toilettalkapi extends REST_Controller
{
    ...
    function response_get()
    {
        ...
        re.gender,re.flags,re.thumbs_up,re.thumbs_down,re.time_stamp,re.review_star_rating,                 
        re.restroom_id,im.img_id,im.filepath                 
        from response re LEFT JOIN images im on re.review_id = im.review_id                  
        where re.restroom_id = 991 order by re.review_id, re.responds_to_id;";
